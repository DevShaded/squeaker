            ...
            <header :class="[open ? 'fixed inset-0 z-40 overflow-y-auto' : '', 'bg-white shadow-sm lg:static lg:overflow-y-visible']">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
                            ...
                            <div class="flex items-center px-6 py-4 md:mx-auto md:max-w-3xl lg:mx-0 lg:max-w-none xl:px-0">
                                <form @submit.prevent="submit" class="w-full">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input v-model="form.name" id="search" name="search" class="block w-full rounded-md border-0 bg-white py-1.5 pl-10 pr-3 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6" placeholder="Search for a user!" type="search" />
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                            ...
                            <Link href="/post/create" class="ml-6 inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">New Post</Link>
                        </div>
                    </div>
                </div>
                ...
                <PopoverPanel as="nav" class="lg:hidden" aria-label="Global">
                    ...
                    <div class="mx-auto mt-6 max-w-3xl px-4 sm:px-6">
                        <Link href="/post/create" class="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">New Post</Link>
                    </div>
                </PopoverPanel>
            </header>
        </Popover>
